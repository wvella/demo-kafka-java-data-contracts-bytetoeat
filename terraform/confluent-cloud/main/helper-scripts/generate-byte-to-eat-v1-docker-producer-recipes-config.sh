...
AZURE_CLIENT_ID=$(terraform -chdir="$TERRAFORM_DIR" output -raw azure-java-producer-client-id)
AZURE_CLIENT_SECRET=$(terraform -chdir="$TERRAFORM_DIR" output -raw azure-java-producer-client-secret)
